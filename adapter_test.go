...
func TestAdapters(t *testing.T) {
	...
	if err = db.Ping(); err != nil {
		t.Fatalf("sql.Ping failed, err: %v", err)
	}
...
func testSQL(t *testing.T, db *sql.DB, tableName string) {
	var err error
...
func initPolicy(t *testing.T, db *sql.DB, tableName string) {
...
func testSaveLoad(t *testing.T, db *sql.DB, tableName string) {
...
func testAutoSave(t *testing.T, db *sql.DB, tableName string) {
	// Initialize some policy in DB.
	initPolicy(t, db, tableName)
	// Note: you don't need to look at the above code
	// if you already have a working DB with policy inside.
...
func testFilteredPolicy(t *testing.T, db *sql.DB, tableName string) {
	// Initialize some policy in DB.
	initPolicy(t, db, tableName)
	// Note: you don't need to look at the above code
	// if you already have a working DB with policy inside.
